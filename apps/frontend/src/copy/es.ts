...
const ui: NonNullable<LocaleDeck["ui"]> = {
  ...
  page: {
    ...
    summaryMapped: {
      one: "{city} tiene {count} {noun} en el mapa.",
      other: "{city} tiene {count} {noun} en el mapa.",
    },
    summaryFeeBoth: "Acceso gratuito: {free}; de pago: {paid}.",
    summaryFeeFree: "Acceso gratuito: {free}.",
    summaryStepFree: "Acceso sin escalones: {stepFree}.",
    summaryListed: {
      one: "La lista de abajo muestra {listed}: {examples}.",
      other: "La lista de abajo muestra {listed}, entre ellos {examples}.",
    },
    landmarksHeading: "{noun} cerca de los monumentos: {sights}",
    landmarkWithin: "{count} a menos de {radius} m",
    landmarkNoneWithin: "ninguno a menos de {radius} m",
    landmarkClosest: "el más cercano a {distance} m {direction}",
    landmarkDirections: {
      n: "al norte",
      ne: "al noreste",
      e: "al este",
    ...
    landmarksNote:
      "Distancias en línea recta desde el centro de cada monumento. La distancia abre el punto en el mapa.",
    categoryDescriptionNear:
      "{count} {noun} en {city} en un mapa, y los más cercanos a {sights}. Gratis, sin registro.",
    countryTitle:
  ...
  poi: {
    ...
    lastCheckedAndEdited: "Última comprobación y modificación",
    editInOsm: "Editar este punto en OpenStreetMap",
    noDetailsYet: "Todavía no se han mapeado detalles de este lugar.",
    noise: {
    ...
    air: {
      ...
      aboutModerate: "Moderada — de 20 a 25 µg/m³. Las personas sensibles pueden notarla.",
      aboutPoor: "Mala — de 25 a 50 µg/m³. Conviene acortar el ejercicio intenso al aire libre.",
      aboutVeryPoor: "Muy mala — de 50 a 75 µg/m³.",
      aboutExtremelyPoor: "Extremadamente mala — por encima de 75 µg/m³.",
      aboutLimit:
    ...
    buildingLastCheckedAndEdited: "Edificio comprobado y modificado el",
