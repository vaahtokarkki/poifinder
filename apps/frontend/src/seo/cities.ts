...
export const CITIES: City[] = [
  ...
  { slug: "vantaa", name: "Vantaa", country: "Finland", countryCode: "FI", lat: 60.2934, lon: 25.0378, tier: 2, langs: ["fi"], names: { fi: { name: "Vantaa", inCity: "Vantaalla" } } },
  { slug: "oulu", name: "Oulu", country: "Finland", countryCode: "FI", lat: 65.0121, lon: 25.4651, tier: 2, langs: ["fi"], names: { fi: { name: "Oulu", inCity: "Oulussa" } } },
  { slug: "jyvaskyla", name: "Jyväskylä", country: "Finland", countryCode: "FI", lat: 62.2426, lon: 25.7473, tier: 3, langs: ["fi"], names: { fi: { name: "Jyväskylä", inCity: "Jyväskylässä" } } },
  { slug: "kuopio", name: "Kuopio", country: "Finland", countryCode: "FI", lat: 62.8924, lon: 27.677, tier: 3, langs: ["fi"], names: { fi: { name: "Kuopio", inCity: "Kuopiossa" } } },
  { slug: "lahti", name: "Lahti", country: "Finland", countryCode: "FI", lat: 60.9827, lon: 25.6612, tier: 3, langs: ["fi"], names: { fi: { name: "Lahti", inCity: "Lahdessa" } } },
  { slug: "pori", name: "Pori", country: "Finland", countryCode: "FI", lat: 61.4851, lon: 21.7972, tier: 3, langs: ["fi"], names: { fi: { name: "Pori", inCity: "Porissa" } } },
  { slug: "joensuu", name: "Joensuu", country: "Finland", countryCode: "FI", lat: 62.601, lon: 29.7636, tier: 3, langs: ["fi"], names: { fi: { name: "Joensuu", inCity: "Joensuussa" } } },
  { slug: "lappeenranta", name: "Lappeenranta", country: "Finland", countryCode: "FI", lat: 61.0587, lon: 28.1887, tier: 3, langs: ["fi"], names: { fi: { name: "Lappeenranta", inCity: "Lappeenrannassa" } } },
  { slug: "kouvola", name: "Kouvola", country: "Finland", countryCode: "FI", lat: 60.8681, lon: 26.7042, tier: 3, langs: ["fi"], names: { fi: { name: "Kouvola", inCity: "Kouvolassa" } } },
  { slug: "rovaniemi", name: "Rovaniemi", country: "Finland", countryCode: "FI", lat: 66.5039, lon: 25.7294, tier: 2, langs: ["fi"], names: { fi: { name: "Rovaniemi", inCity: "Rovaniemellä" } } },
  { slug: "vaasa", name: "Vaasa", country: "Finland", countryCode: "FI", lat: 63.0951, lon: 21.6165, tier: 3, langs: ["fi"], names: { fi: { name: "Vaasa", inCity: "Vaasassa" } } },
  { slug: "hameenlinna", name: "Hämeenlinna", country: "Finland", countryCode: "FI", lat: 60.9959, lon: 24.4643, tier: 3, langs: ["fi"], names: { fi: { name: "Hämeenlinna", inCity: "Hämeenlinnassa" } } },
  { slug: "porvoo", name: "Porvoo", country: "Finland", countryCode: "FI", lat: 60.3932, lon: 25.6639, tier: 3, langs: ["fi"], names: { fi: { name: "Porvoo", inCity: "Porvoossa" } } },
  { slug: "rauma", name: "Rauma", country: "Finland", countryCode: "FI", lat: 61.1272, lon: 21.5114, tier: 3, langs: ["fi"], names: { fi: { name: "Rauma", inCity: "Raumalla" } } },
  { slug: "kotka", name: "Kotka", country: "Finland", countryCode: "FI", lat: 60.4664, lon: 26.9458, tier: 3, langs: ["fi"], names: { fi: { name: "Kotka", inCity: "Kotkassa" } } },
  { slug: "stockholm", name: "Stockholm", country: "Sweden", countryCode: "SE", lat: 59.3293, lon: 18.0686, tier: 1, names: { es: "Estocolmo", it: "Stoccolma", fi: { name: "Tukholma", inCity: "Tukholmassa" } } },
  { slug: "gothenburg", name: "Gothenburg", country: "Sweden", countryCode: "SE", lat: 57.7089, lon: 11.9746, tier: 2, names: { es: "Gotemburgo", it: "Göteborg", fr: "Göteborg", fi: { name: "Göteborg", inCity: "Göteborgissa" } } },
  ...
  { slug: "copenhagen", name: "Copenhagen", country: "Denmark", countryCode: "DK", lat: 55.6761, lon: 12.5683, tier: 1, names: { es: "Copenhague", it: "Copenaghen", fr: "Copenhague", fi: { name: "Kööpenhamina", inCity: "Kööpenhaminassa" } } },
  ...
  { slug: "warsaw", name: "Warsaw", country: "Poland", countryCode: "PL", lat: 52.2297, lon: 21.0122, tier: 2, names: { es: "Varsovia", it: "Varsavia", fr: "Varsovie", fi: { name: "Varsova", inCity: "Varsovassa" } } },
  ...
  { slug: "prague", name: "Prague", country: "Czechia", countryCode: "CZ", lat: 50.0755, lon: 14.4378, tier: 1, names: { es: "Praga", it: "Praga", fi: { name: "Praha", inCity: "Prahassa" } } },
  ...
  { slug: "athens", name: "Athens", country: "Greece", countryCode: "GR", lat: 37.9838, lon: 23.7275, tier: 2, names: { es: "Atenas", it: "Atene", fr: "Athènes", fi: { name: "Ateena", inCity: "Ateenassa" } } },

  // ---- Europe: German speaking ----
  { slug: "berlin", name: "Berlin", country: "Germany", countryCode: "DE", lat: 52.52, lon: 13.405, radius: 12000, tier: 1, langs: ["de"], names: { es: "Berlín", it: "Berlino", fi: { name: "Berliini", inCity: "Berliinissä" } } },
  { slug: "munich", name: "Munich", country: "Germany", countryCode: "DE", lat: 48.1351, lon: 11.582, tier: 1, langs: ["de"], names: { es: "Múnich", it: "Monaco di Baviera", fi: { name: "München", inCity: "Münchenissä" }, de: "München" } },
  ...
  { slug: "cologne", name: "Cologne", country: "Germany", countryCode: "DE", lat: 50.9375, lon: 6.9603, tier: 2, langs: ["de"], names: { es: "Colonia", it: "Colonia", fr: "Cologne", fi: { name: "Köln", inCity: "Kölnissä" }, de: "Köln" } },
  ...
  { slug: "vienna", name: "Vienna", country: "Austria", countryCode: "AT", lat: 48.2082, lon: 16.3738, tier: 1, langs: ["de"], names: { es: "Viena", fr: "Vienne", fi: { name: "Wien", inCity: "Wienissä" }, de: "Wien" } },
  ...
  { slug: "zurich", name: "Zurich", country: "Switzerland", countryCode: "CH", lat: 47.3769, lon: 8.5417, tier: 1, langs: ["de"], names: { es: "Zúrich", it: "Zurigo", fi: { name: "Zürich", inCity: "Zürichissä" }, de: "Zürich" } },
  { slug: "geneva", name: "Geneva", country: "Switzerland", countryCode: "CH", lat: 46.2044, lon: 6.1432, tier: 2, langs: ["fr"], names: { fr: "Genève", fi: { name: "Geneve", inCity: "Genevessä" } } },
  ...
  { slug: "amsterdam", name: "Amsterdam", country: "Netherlands", countryCode: "NL", lat: 52.3676, lon: 4.9041, tier: 1, names: { es: "Ámsterdam", fi: { name: "Amsterdam", inCity: "Amsterdamissa" } } },
  ...
  { slug: "the-hague", name: "The Hague", country: "Netherlands", countryCode: "NL", lat: 52.0705, lon: 4.3007, tier: 3, names: { es: "La Haya", it: "L'Aia", fr: "La Haye", fi: { name: "Haag", inCity: "Haagissa" } } },
  { slug: "brussels", name: "Brussels", country: "Belgium", countryCode: "BE", lat: 50.8476, lon: 4.3572, tier: 1, langs: ["fr"], names: { es: "Bruselas", it: "Bruxelles", fr: "Bruxelles", fi: { name: "Bryssel", inCity: "Brysselissä" } } },
  { slug: "antwerp", name: "Antwerp", country: "Belgium", countryCode: "BE", lat: 51.2194, lon: 4.4025, tier: 3, names: { es: "Amberes", it: "Anversa", fr: "Anvers", fi: { name: "Antwerpen", inCity: "Antwerpenissä" } } },
  { slug: "ghent", name: "Ghent", country: "Belgium", countryCode: "BE", lat: 51.0543, lon: 3.7174, tier: 3, names: { fi: { name: "Gent", inCity: "Gentissä" } } },
  { slug: "luxembourg", name: "Luxembourg", country: "Luxembourg", countryCode: "LU", lat: 49.6116, lon: 6.1319, tier: 3, langs: ["fr"], names: { fi: { name: "Luxemburg", inCity: "Luxemburgissa" } } },

  // ---- Europe: British Isles ----
  { slug: "london", name: "London", country: "United Kingdom", countryCode: "GB", lat: 51.5074, lon: -0.1278, radius: 12000, tier: 1, names: { es: "Londres", it: "Londra", fr: "Londres", fi: { name: "Lontoo", inCity: "Lontoossa" } } },
  ...
  { slug: "edinburgh", name: "Edinburgh", country: "United Kingdom", countryCode: "GB", lat: 55.9533, lon: -3.1883, tier: 1, names: { es: "Edimburgo", it: "Edimburgo", fr: "Édimbourg", fi: { name: "Edinburgh", inCity: "Edinburghissa" } } },
  ...
  { slug: "dublin", name: "Dublin", country: "Ireland", countryCode: "IE", lat: 53.3498, lon: -6.2603, tier: 1, names: { es: "Dublín", it: "Dublino", fi: { name: "Dublin", inCity: "Dublinissa" } } },
  { slug: "cork", name: "Cork", country: "Ireland", countryCode: "IE", lat: 51.8985, lon: -8.4756, tier: 3, names: { fi: { name: "Cork", inCity: "Corkissa" } } },

  // ---- Europe: France ----
  { slug: "paris", name: "Paris", country: "France", countryCode: "FR", lat: 48.8566, lon: 2.3522, tier: 1, langs: ["fr"], names: { es: "París", it: "Parigi", fi: { name: "Pariisi", inCity: "Pariisissa" } } },
  { slug: "lyon", name: "Lyon", country: "France", countryCode: "FR", lat: 45.764, lon: 4.8357, tier: 2, langs: ["fr"], names: { fi: { name: "Lyon", inCity: "Lyonissa" } } },
  { slug: "marseille", name: "Marseille", country: "France", countryCode: "FR", lat: 43.2965, lon: 5.3698, tier: 2, langs: ["fr"], names: { fi: { name: "Marseille", inCity: "Marseillessa" } } },
  { slug: "bordeaux", name: "Bordeaux", country: "France", countryCode: "FR", lat: 44.8378, lon: -0.5792, tier: 2, langs: ["fr"], names: { fi: { name: "Bordeaux", inCity: "Bordeaux'ssa" } } },
  { slug: "nice", name: "Nice", country: "France", countryCode: "FR", lat: 43.7102, lon: 7.262, tier: 2, langs: ["fr"], names: { fi: { name: "Nizza", inCity: "Nizzassa" } } },
  { slug: "toulouse", name: "Toulouse", country: "France", countryCode: "FR", lat: 43.6047, lon: 1.4442, tier: 3, langs: ["fr"], names: { fi: { name: "Toulouse", inCity: "Toulousessa" } } },
  { slug: "nantes", name: "Nantes", country: "France", countryCode: "FR", lat: 47.2184, lon: -1.5536, tier: 3, langs: ["fr"], names: { fi: { name: "Nantes", inCity: "Nantesissa" } } },
  { slug: "strasbourg", name: "Strasbourg", country: "France", countryCode: "FR", lat: 48.5734, lon: 7.7521, tier: 3, langs: ["fr"], names: { fi: { name: "Strasbourg", inCity: "Strasbourgissa" } } },
  { slug: "lille", name: "Lille", country: "France", countryCode: "FR", lat: 50.6292, lon: 3.0573, tier: 3, langs: ["fr"], names: { fi: { name: "Lille", inCity: "Lillessä" } } },
  { slug: "montpellier", name: "Montpellier", country: "France", countryCode: "FR", lat: 43.6108, lon: 3.8767, tier: 3, langs: ["fr"], names: { fi: { name: "Montpellier", inCity: "Montpellier'ssa" } } },

  // ---- Europe: Iberia and Italy ----
  { slug: "madrid", name: "Madrid", country: "Spain", countryCode: "ES", lat: 40.4168, lon: -3.7038, tier: 1, langs: ["es"], names: { fi: { name: "Madrid", inCity: "Madridissa" } } },
  { slug: "barcelona", name: "Barcelona", country: "Spain", countryCode: "ES", lat: 41.3874, lon: 2.1686, tier: 1, langs: ["es"], names: { it: "Barcellona", fi: { name: "Barcelona", inCity: "Barcelonassa" } } },
  { slug: "valencia", name: "Valencia", country: "Spain", countryCode: "ES", lat: 39.4699, lon: -0.3763, tier: 2, langs: ["es"], names: { fi: { name: "Valencia", inCity: "Valenciassa" } } },
  { slug: "seville", name: "Seville", country: "Spain", countryCode: "ES", lat: 37.3891, lon: -5.9845, tier: 2, langs: ["es"], names: { it: "Siviglia", fr: "Séville", es: "Sevilla", fi: { name: "Sevilla", inCity: "Sevillassa" } } },
  { slug: "malaga", name: "Málaga", country: "Spain", countryCode: "ES", lat: 36.7213, lon: -4.4214, tier: 3, langs: ["es"], names: { fi: { name: "Málaga", inCity: "Málagassa" } } },
  { slug: "bilbao", name: "Bilbao", country: "Spain", countryCode: "ES", lat: 43.263, lon: -2.935, tier: 3, langs: ["es"], names: { fi: { name: "Bilbao", inCity: "Bilbaossa" } } },
  { slug: "lisbon", name: "Lisbon", country: "Portugal", countryCode: "PT", lat: 38.7223, lon: -9.1393, tier: 1, names: { es: "Lisboa", it: "Lisbona", fr: "Lisbonne", fi: { name: "Lissabon", inCity: "Lissabonissa" } } },
  { slug: "porto", name: "Porto", country: "Portugal", countryCode: "PT", lat: 41.1579, lon: -8.6291, tier: 2, names: { fi: { name: "Porto", inCity: "Portossa" } } },
  { slug: "rome", name: "Rome", country: "Italy", countryCode: "IT", lat: 41.9028, lon: 12.4964, tier: 1, langs: ["it"], names: { es: "Roma", it: "Roma", fi: { name: "Rooma", inCity: "Roomassa" } } },
  { slug: "milan", name: "Milan", country: "Italy", countryCode: "IT", lat: 45.4642, lon: 9.19, tier: 1, langs: ["it"], names: { es: "Milán", it: "Milano", fi: { name: "Milano", inCity: "Milanossa" } } },
  { slug: "florence", name: "Florence", country: "Italy", countryCode: "IT", lat: 43.7696, lon: 11.2558, tier: 2, langs: ["it"], names: { es: "Florencia", fr: "Florence", it: "Firenze", fi: { name: "Firenze", inCity: "Firenzessä" } } },
  { slug: "venice", name: "Venice", country: "Italy", countryCode: "IT", lat: 45.4408, lon: 12.3155, radius: 6000, tier: 2, langs: ["it"], names: { es: "Venecia", fr: "Venise", it: "Venezia", fi: { name: "Venetsia", inCity: "Venetsiassa" } } },
  { slug: "naples", name: "Naples", country: "Italy", countryCode: "IT", lat: 40.8518, lon: 14.2681, tier: 2, langs: ["it"], names: { es: "Nápoles", it: "Napoli", fi: { name: "Napoli", inCity: "Napolissa" } } },
  { slug: "turin", name: "Turin", country: "Italy", countryCode: "IT", lat: 45.0703, lon: 7.6869, tier: 3, langs: ["it"], names: { es: "Turín", it: "Torino", fi: { name: "Torino", inCity: "Torinossa" } } },
  { slug: "bologna", name: "Bologna", country: "Italy", countryCode: "IT", lat: 44.4949, lon: 11.3426, tier: 3, langs: ["it"], names: { fi: { name: "Bologna", inCity: "Bolognassa" } } },
  ...
  { slug: "mexico-city", name: "Mexico City", country: "Mexico", countryCode: "MX", lat: 19.4326, lon: -99.1332, radius: 12000, tier: 2, langs: ["es"], names: { es: "Ciudad de México", fi: { name: "Mexico City", inCity: "Mexico Cityssä" } } },
  ...
  { slug: "buenos-aires", name: "Buenos Aires", country: "Argentina", countryCode: "AR", lat: -34.6037, lon: -58.3816, radius: 12000, tier: 3, langs: ["es"], names: { fi: { name: "Buenos Aires", inCity: "Buenos Airesissa" } } },
  { slug: "santiago", name: "Santiago", country: "Chile", countryCode: "CL", lat: -33.4489, lon: -70.6693, tier: 3, langs: ["es"], names: { fi: { name: "Santiago", inCity: "Santiagossa" } } },
