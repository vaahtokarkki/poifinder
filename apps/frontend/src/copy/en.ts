...
const ui: CopyDeck["ui"] = {
  ...
  sheet: {
    ...
    aboutHeading: "About Wayside",
    aboutDataBefore: "Every point on this map comes from",
    aboutDataLink: "OpenStreetMap",
    aboutDataAfter:
      ", the free map of the world that volunteers build and keep up to date, much like Wikipedia. Wayside shows the points as they are mapped there and adds nothing of its own.",
    aboutFixBefore: "Something missing or wrong? The fix belongs in OpenStreetMap, where anyone can",
    aboutFixLink: "add or correct a place",
    aboutFixAfter: ", and it shows up here after the next update.",
    aboutLayers:
      "The noise layer is modelled from OpenStreetMap roads and railways. The air layer interpolates readings from official stations, via OpenAQ, and from Sensor.Community's volunteer sensors.",
    aboutIndependent:
      "Wayside is an independent open source project, not run by or affiliated with the OpenStreetMap Foundation. It is free to use, with no ads, no accounts and no tracking cookies.",
    aboutContact: "Contact:",
    creditsSourceBefore: "Map data ©",
    creditsSourceLink: "OpenStreetMap contributors",
    creditsSourceAfter: ", available under the Open Database Licence.",
  ...
  page: {
    ...
    countryDescription:
      "{count} {noun} in {countryIn}, mapped across {cities} {cityUnit} and shown on one map. Built from OpenStreetMap. Free, no signup, works on your phone.",
    countryHeading: "{noun} in {countryIn}",
    countrySummary: "{count} mapped points across {cities} {cityUnit} in {countryIn}.",
    countryCitiesHeading: "Cities in {countryIn}",
  ...
  poi: {
    ...
    addDetailsInOsm: "Add details in OpenStreetMap",
    noise: {
      label: "Traffic noise",
      quiet: "Quiet",
      moderate: "Moderate",
    ...
    air: {
      ...
      aboutModerate: "Moderate — 20 to 25 µg/m³. Sensitive people may notice it.",
      aboutPoor: "Poor — 25 to 50 µg/m³. Worth shortening hard exercise outdoors.",
      aboutVeryPoor: "Very poor — 50 to 75 µg/m³.",
      aboutExtremelyPoor: "Extremely poor — above 75 µg/m³.",
      aboutLimit:
