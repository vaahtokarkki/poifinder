...
const ui: NonNullable<LocaleDeck["ui"]> = {
  ...
  sheet: {
    ...
    aboutHeading: "Tietoa Waysidesta",
    aboutDataBefore: "Kaikki kartan pisteet ovat peräisin",
    aboutDataLink: "OpenStreetMapista",
    aboutDataAfter:
      ", vapaasta maailmankartasta, jota vapaaehtoiset rakentavat ja pitävät ajan tasalla vähän kuin Wikipediaa. Wayside näyttää pisteet sellaisina kuin ne on sinne kartoitettu eikä lisää niihin mitään omaa.",
    aboutFixBefore: "Puuttuuko jotain tai onko jokin väärin? Korjaus tehdään OpenStreetMapiin, jossa kuka tahansa voi",
    aboutFixLink: "lisätä tai korjata paikan",
    aboutFixAfter: ". Muutos näkyy täälläkin seuraavan päivityksen jälkeen.",
    aboutLayers:
      "Melutaso on mallinnettu OpenStreetMapin teistä ja rautateistä. Ilmanlaatutaso interpoloi virallisten mittausasemien lukemia OpenAQ:n kautta sekä Sensor.Communityn vapaaehtoisten antureiden lukemia.",
    aboutIndependent:
      "Wayside on itsenäinen avoimen lähdekoodin projekti. OpenStreetMap Foundation ei ylläpidä sitä, eikä se ole sidoksissa säätiöön. Käyttö on maksutonta, eikä siinä ole mainoksia, käyttäjätilejä tai seurantaevästeitä.",
    aboutContact: "Yhteystiedot:",
    creditsSourceBefore: "Karttatiedot ©",
    creditsSourceLink: "OpenStreetMapin tekijät",
    creditsSourceAfter: ", Open Database License -lisenssillä.",
  ...
  poi: {
    ...
    air: {
      ...
      aboutModerate: "Välttävä — 20–25 µg/m³. Herkät voivat huomata sen.",
      aboutPoor: "Huono — 25–50 µg/m³. Rankkaa ulkoliikuntaa kannattaa lyhentää.",
      aboutVeryPoor: "Erittäin huono — 50–75 µg/m³.",
      aboutExtremelyPoor: "Vaarallinen — yli 75 µg/m³.",
      aboutLimit:
    ...
    buildingLastCheckedAndEdited: "Rakennus tarkistettu ja muokattu viimeksi",
