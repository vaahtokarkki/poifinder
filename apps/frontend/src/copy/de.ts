...
const ui: NonNullable<LocaleDeck["ui"]> = {
  ...
  sheet: {
    ...
    aboutHeading: "Über Wayside",
    aboutDataBefore: "Jeder Punkt auf dieser Karte stammt aus",
    aboutDataLink: "OpenStreetMap",
    aboutDataAfter:
      ", der freien Weltkarte, die Freiwillige erstellen und aktuell halten, ähnlich wie Wikipedia. Wayside zeigt die Punkte so, wie sie dort eingetragen sind, und fügt nichts Eigenes hinzu.",
    aboutFixBefore: "Fehlt etwas oder stimmt etwas nicht? Korrigiert wird in OpenStreetMap, wo alle",
    aboutFixLink: "einen Ort ergänzen oder berichtigen können",
    aboutFixAfter: ". Nach der nächsten Aktualisierung erscheint die Änderung auch hier.",
    aboutLayers:
      "Die Lärmebene ist aus Straßen und Bahnstrecken in OpenStreetMap modelliert. Die Luftebene interpoliert Messwerte offizieller Stationen über OpenAQ und ehrenamtlicher Sensoren von Sensor.Community.",
    aboutIndependent:
      "Wayside ist ein unabhängiges Open-Source-Projekt und wird weder von der OpenStreetMap Foundation betrieben noch ist es mit ihr verbunden. Die Nutzung ist kostenlos, ohne Werbung, ohne Konto und ohne Tracking-Cookies.",
    aboutContact: "Kontakt:",
    creditsSourceBefore: "Kartendaten ©",
    creditsSourceLink: "OpenStreetMap-Mitwirkende",
    creditsSourceAfter: ", verfügbar unter der Open Database License.",
  ...
  poi: {
    ...
    distanceMetres: "{distance} m entfernt",
    ...
    buildingLastCheckedAndEdited: "Gebäude zuletzt geprüft und bearbeitet",
